...
export default function Home() {
  return (
    <section id="Home" className="fixed top-0 left-[5lvw] h-[100lvh] w-[95lvw] flex flex-col pt-[max(100px,15lvh)] m d:pt-0 justify-between m d:justify-center items-center overflow-hidden">
